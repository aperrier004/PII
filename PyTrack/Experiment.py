...
class Experiment:
	...
	def __init__(self, json_file, csv_path, reading_method="SQL", aoi="NA"):
		...
		self.subjects = self.subjectArrayInitialisation(csv_path,reading_method) #list of subject objects
	...
	def subjectArrayInitialisation(self,path, reading_method):
