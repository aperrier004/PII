...
class PageThree(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        generateCompatibleFormat(exp_path="F:/PII/Test/smi_eyetracker_freeviewing.txt",
                                 device="smi",
                                 stim_list_mode='NA',
                                 start='12',
                                 stop='99')

        df = pd.read_csv("F:/PII/Test/smi_eyetracker_freeviewing.csv")
        ...
        # LIGNE QUI POSE PROBLEME JE SUPPOSE
        # En premier argument il attend une figure
        canvas = FigureCanvasTkAgg(stim.gazePlot(save_fig=True), self)
